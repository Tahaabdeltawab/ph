...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            send() {
                axios.post('/api/group/chat/message/send',{
            ...
            sendFiles() {
                ...
                axios.post('/api/group/chat/message/send/file', data);
            },
            leaveFromGroup() {
                axios.post('/api/group/chat/leave/' + this.groupConversationId ).then((response) => {
                    window.location = '/'
                });
            },
