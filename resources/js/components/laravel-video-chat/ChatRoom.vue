            ...
            <div class="col-md-6">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <span class="glyphicon glyphicon-comment"></span> Chat with {{ withUser.username }}
                    ...
                    <div class="panel-body">
                        <ul class="chat" v-chat-scroll>
                            ...
                            <span class="chat-img" v-bind:class="{ 'pull-right' : check(message.sender.id) , 'pull-left' : !check(message.sender.id) }">
                                <img :src="'http://placehold.it/50/FA6F57/fff&text='+ message.sender.username" alt="User Avatar" class="img-circle" />
                            </span>
...
<script>
    ...
    $(function () {
        ...
        var answerButton = $('#answerCallButton');
        // answerButton.onclick = answerCall;

        answerButton.on('click', answerCall);
...
import axios from "axios";
    ...
    export default {
        ...
        methods: {
            ...
            sendFiles() {
                ...
                axios.post('/api/chat/message/send/file', data);
            },
    ...
    function onCreateAnswerSuccess(desc) {
        ...
        axios.post('/api/trigger/' + conversationID , message );
    }
