        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="body">
                            <form id="basic-form" method="post"action="{{url('admin/add_image')}}" novalidate enctype="multipart/form-data" >
                                                    {{ csrf_field() }}
