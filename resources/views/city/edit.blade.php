            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12" >
                        <h2 style="font-size: xx-large;"> تعديل المحافظة :</h2>
                    </div>
                    <div class="col-lg-7 col-md-4 col-sm-12">
                        <ul class="breadcrumb justify-content-end">
                            <li class="breadcrumb-item"><a href="{{url('admin/home')}}"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item"> بيانات المحافظة</li>
                        </ul>
                    </div>
                </div>
            </div>
             ...
             <div class="body">
                 <form id="basic-form" method="post"action="{{url('admin/update_city')}}" novalidate enctype="multipart/form-data">
                                           {{ csrf_field() }}
