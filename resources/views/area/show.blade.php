                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="nav nav-tabs-new ">
                                <li ><h2 style="font-size: xx-large;">المدن :</h2> </li> &nbsp;&nbsp;
                                <li class="nav-item" style="margin-top: -5px;font-size: x-large;"><a class="nav-link"  href="{{url('admin/newArea')}}">اضافة مدينة</a></li>
                            </ul>
                        </div>
                        <div class="body">
                                       ...
                                       @foreach($data as $cat)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{url('admin/editArea')}}" method="GET"  id="sub_{{$cat->id}}" enctype="multipart/form-data">

                                                    {{ csrf_field() }}

                                                    <input type="hidden" name="area_id" value="{{$cat->id}}">
                                            ...
                                            <td>
                                               ...
                                               <form action="{{url('admin/delete_area')}}" method="GET"  id="sub_{{$cat->id}}" enctype="multipart/form-data">
