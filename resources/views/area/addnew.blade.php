        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        <h2 style="font-size: xx-large;" > اضافة مدينة</h2>
                    </div>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="body">
                            <form id="basic-form" method="post"action="{{url('admin/Add_area')}}" novalidate enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <label style="    font-size: x-large;">المحافظة</label>

                                        <select class="form-control text-right "  name="city_id" style="direction: rtl" required>
                                          <option style="display:none">أختر المحافظة</option>
