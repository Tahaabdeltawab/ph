...
<div id="main-content">
        <div class="container-fluid">
            <div class="block-header">
             ...
             <div class="body">
                 <form id="basic-form" method="post"action="{{url('admin/update_area')}}" novalidate enctype="multipart/form-data">
                                           {{ csrf_field() }}
                        ...
                        <br>
                        <button type="submit" name="edit_category"class="btn btn-primary" style="margin-right: 556px;font-size: 22px;">حفظ</button>                          <br><br>
